...
public:
  enum {
    ...
    T__20 = 21, T__21 = 22, T__22 = 23, PACKAGE = 24, CONST = 25, TYPE = 26, 
    ARRAY = 27, OF = 28, RECORD = 29, VAR = 30, DIV = 31, MOD = 32, AND = 33, 
    OR = 34, NOT = 35, IF = 36, THEN = 37, ELSE = 38, SWITCH = 39, CASE = 40, 
    FOR = 41, PRINT = 42, PRINTLN = 43, FUNC = 44, DEFAULT = 45, IDENTIFIER = 46, 
    INT = 47, DOUBLE = 48, NEWLINE = 49, WS = 50, QUOTE = 51, CHAR = 52, 
  ...
  enum {
    ...
    RuleCaseConstantList = 51, RuleCaseConstant = 52, RuleForStatement = 53, 
    RuleWhileStatement = 54, RuleProcedureCallStatement = 55, RuleProcedureName = 56, 
    RuleArgumentList = 57, RuleArgument = 58, RuleWriteStatement = 59, RuleWritelnStatement = 60, 
    RuleWriteArguments = 61, RuleWriteArgument = 62, RuleFieldWidth = 63, 
    RuleDecimalPlaces = 64, RuleExpression = 65, RuleSimpleExpression = 66, 
    RuleTerm = 67, RuleFactor = 68, RuleVariable = 69, RuleModifier = 70, 
    RuleIndexList = 71, RuleIndex = 72, RuleField = 73, RuleFunctionCall = 74, 
    RuleFunctionName = 75, RuleNumber = 76, RuleUnsignedNumber = 77, RuleIntegerConstant = 78, 
    RuleRealConstant = 79, RuleCharacterConstant = 80, RuleStringConstant = 81, 
    RuleRelOp = 82, RuleAddOp = 83, RuleMulOp = 84
  };
